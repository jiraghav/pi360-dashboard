...
export default function GreetingHeader({ userName, loading }) {
  ...
  return (
    <section className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
      ...
      <div>
        {loading ? (
          <div className="text-center md:text-left mb-2 animate-pulse">
      ...
      <div className="mt-4 md:mt-0">
        <button
          ...
          className="btn btn-sm px-4 py-2 font-medium rounded-md transition flex items-center gap-2"
        >
          <Calendar className="w-5 h-5 text-mint-400" />
          <span>Referrals Reference</span>
        </button>
      </div>
